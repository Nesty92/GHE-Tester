...
<html>
    ...
    <body>    
        ...
        <div id="page-content" class="container">
            <center>
                <h1>Grupo de Hacking Ético</h1>
                <img src="<?php echo THEMEPATH; ?>/img/Whitehat.png" width="200">
            </center>
                    ...
                    <li data-name="<?php echo $name; ?>" data-href="<?php echo $fileInfo['url_path']; ?>">
                        ...
                        <?php else: ?>
                               <?php if ($lister->containsIndex($fileInfo['file_path'])):  ?>
                                ...
                                <a href="<?php echo $fileInfo['file_path']; ?>" class="clearfix" data-name="<?php echo $name; ?>" target="_blank">
